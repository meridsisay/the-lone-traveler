                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-700 dark:text-gray-300">
                      <a href="mailto:contact@thelonetraveler.com" className="hover:text-blue-600 dark:hover:text-blue-400">
                        contact@thelonetraveler.com
                      </a>
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a
                    ...
                    className="p-3 bg-gray-200 dark:bg-gray-700 rounded-full hover:bg-pink-100 dark:hover:bg-pink-900 transition-colors"
